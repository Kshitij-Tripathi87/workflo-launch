 ...
 * graphite planes, and restrained Verification Mint make autonomous QA inspectable.
 */
...
const runStages = [
  { label: "Environment ready", detail: "Isolated browser allocated", trace: "runtime provisioned", progress: 24, step: 0 },
  { label: "Test in progress", detail: "Checkout path under evaluation", trace: "test steps executing", progress: 58, step: 1 },
  { label: "Evidence assembling", detail: "Events and artifacts recorded", trace: "receipt data being sealed", progress: 81, step: 2 },
  { label: "Receipt available", detail: "Execution record verified", trace: "attestation complete", progress: 100, step: 2 },
];
    ...
    <main>
      <section className="hero-section">
        ...
        <div className="hero-visual reveal-up reveal-delay-1">
          ...
          <div className="hero-live-panel" aria-live="polite"><div><span className="live-panel-label">CURRENT STATE</span><strong>{activeRun.label}</strong><small>{activeRun.detail}</small></div><SignalDot /><div className="live-meter"><i style={{ transform: `scaleX(${activeRun.progress / 100})` }} /></div></div>
